...
def add_address_inf():
    """
    Use set_name() and set_cmt() and REGISTERS collections 
    """
    pass
...
def accept_file(file, n):
    """
    file.seek() allows displacement in the file
    file.read() allows to read specific part (binary format)
    """

    ok = False
    # TODO accept or not file 
    if ok:
...
def load_file(li, neflags, format):
    ...
    # TODO: Set the processor type to ARM Little Endian 
    
    # TODO: Add segment, see add_segm() and SEGMENT collections

    # TODO: fix segment permission, see fix_perm()

    # TODO: map input binary file to address space, see file2base()
